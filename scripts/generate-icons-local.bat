...
echo ℹ️  Installing required tools...
npm install -g sharp-cli

REM Create directories
echo ℹ️  Creating output directories...
...
echo   📁 assets\icons\generated\ - PNG files
if exist "assets\icons\ico\microphone.ico" (
    echo   📁 assets\icons\ico\ - ICO files
    echo   📄 microphone.ico - Main application icon
)
